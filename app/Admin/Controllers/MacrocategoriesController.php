...
class MacrocategoriesController extends AdminController
{
    /**
     ...
     * @var string
     */
    protected $title = 'Macrocategories';
    ...
    {
        $grid = new Grid(new Macrocategories());
    ...
    {
        $show = new Show(Macrocategories::findOrFail($id));
    ...
    {
        $form = new Form(new Macrocategories());
