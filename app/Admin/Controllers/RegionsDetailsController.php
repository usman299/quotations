...
class RegionsDetailsController extends AdminController
{
    /**
    ...
    protected function form()
    {
        ...
        $form->text('sigla', __('Sigla'))->rules('required|min:3');
